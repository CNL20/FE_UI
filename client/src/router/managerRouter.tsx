...
import HealthCheckCampaigns from "../pages/ManagerPages/HealthCheckCampaigns"; // <-- Thêm dòng này
...
const ManagerRouter: React.FC<{ onLogout?: () => void }> = ({ onLogout }) => {
  ...
  return (
    <Routes>
      ...
      <Route path="health-check-campaigns" element={<HealthCheckCampaigns />} /> {/* Thêm dòng này */}
