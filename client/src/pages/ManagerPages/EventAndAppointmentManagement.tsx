...
interface EventAndAppointmentManagementProps {
  onLogout?: () => void;
}

const EventAndAppointmentManagement: React.FC<EventAndAppointmentManagementProps> = ({ onLogout }) => {
  return (
    <>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                <Typography variant="h6" align="center">
                  Danh sách lịch hẹn khám sức khỏe tập trung/sự kiện y tế sắp
                  tới
                </Typography>
                <Typography variant="body1" align="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                <Typography variant="body1" align="center">
                  (Placeholder for notifications and reminders for
                  parents/students)
                </Typography>
              </CardContent>
            </Card>
