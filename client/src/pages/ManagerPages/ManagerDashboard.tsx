          ...
          <List>
            {menuItems.map((item, index) => (
              <ListItem button key={index} onClick={item.onClick}>
                <ListItemIcon sx={{ color: "#fff" }}> {/* White icons */}
                  <Assignment />
                </ListItemIcon>
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2">
                (Placeholder for a chart displaying cases over days/months/quarters)
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} md={6} lg={6}>
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2">
                (Placeholder for a chart showing common illnesses in the school)
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} md={6} lg={6}>
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2">
                (Placeholder for a report on health check completion rates by class/grade)
              </Typography>
            </CardContent>
          </Card>
        </Grid>
